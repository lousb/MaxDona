...
const AddProject = ({ inputs, title }) => {
  ...
  useEffect(() => {
    ...
    console.log('section order:', JSON.stringify(sectionOrder, null, 2)); // Properly formatted
    console.log('detail sections:', JSON.stringify(detailSections, null, 2));
    console.log('text sections:', JSON.stringify(textSections, null, 2));
    console.log('large image section:', JSON.stringify(largeImageSections, null, 2));
    console.log('title section:', JSON.stringify(titleSections, null, 2));
  ...
  const handleAddField = (section) => {
    ...
    if (section === "detail" && detailSections.length < 10) {
      sectionType = "detail";
      const newDetailSection = { id: `detail${detailSections.length + 1}`, orderIndex:`${detailSections.length + 1}` };
      ...
      sectionType = "text";
      const newTextSection = { id: `text${textSections.length + 1}`, orderIndex:`${textSections.length + 1}` };
      ...
      const newLargeImageSection = {
        id: `largeImage${largeImageSections.length + 1}`, orderIndex:`${largeImageSections.length + 1}`
      };
      ...
      sectionType = "title";
      const newTitleSection = { id: `title${titleSections.length + 1}`, orderIndex:`${titleSections.length + 1}` };
    ...
    if (newSection) {
      ...
      setSectionOrder((prev) => [
        ...prev,
        { name: sectionType, index: newIndex },
      ]);
  ...
  const handleAdd = async (e) => {
    ...
    try {
      ...
      for (
        let sectionIndex = 1;
        sectionIndex <= imageSectionCount + 2;
        sectionIndex++
      ) {
        ...
        for (
          let fileIndex = 0;
          fileIndex < imageFiles[sectionIndex - 1].length;
          fileIndex++
        ) {
          ...
          if (file) {
            ...
            const blurhashStorageRef = ref(
              storage,
              `image${sectionIndex}/${blurhashName}`
            );
      ...
      for (const detailSection of detailSections) {
        ...
        projectData.details[detailId] = {
          ...
          secondDescription:
            data[`${detailSection.id}-detailsSecondDescription`],
      ...
      for (
        let sectionIndex = 0;
        sectionIndex <= largeImageSections.length;
        sectionIndex++
      ) {
        ...
        if (imageFiles[sectionIndex] && imageFiles[sectionIndex].largeImages) {
          for (
            let fileIndex = 0;
            fileIndex <= imageFiles[sectionIndex].largeImages.length;
            fileIndex++
          ) {
  ...
  const getInitialSections = () => {
    return [
      "main",
      "image0",
      ...Array.from({ length: imageSectionCount }, (_, i) => `image${i + 1}`),
    ];
  };
      ...
      <div className="all-projects-page-wrap">
        ...
        <div className="add-projects-content">
          <div className={`add-projects-list`}>
            <form onSubmit={handleAdd} className={`${isUploading ? 'uploading': ''}`}>
              <div>
                {mainFeaturedImage && (
                  <div className="uploaded-image-wrap">
                    ...
                    />
                    <p className="body">
                      <span>*</span>Keep in mind the featured image will be
                      viewed in variable dimensions, Aim to keep subject matter
                ...
                <div
                  className={`section-title ${
                    mainFeaturedImage && "image-preview"
                  }`}
                >
                  Main Section
                </div>
                ...
                {projectMainSection.map((input) => (
                      ...
                      <div
                        className={`formInput map ${getClassNameFromLabel(
                          input.label
                        )}`}
                        key={input.id}
                      >
              ...
              {sectionOrder.map((section, index) => {
                if (section.name === "main") {
                  ...
                  const detailSection = detailSections.find(
                    (detail) => detail.id === `detail${section.index}`
                  );
                  if (detailSection) {
                      ...
                      <div key={`detail-${section.index}`}>
                        <div className={detailSection.id}>
                          ...
                          {imageFiles[section.index]?.featuredImage && (
                            <img
                              src={URL.createObjectURL(
                                imageFiles[section.index].featuredImage[0]
                              )}
                              alt="featured-image"
                              className="uploaded-image-preview"
                            />
                          ...
                          {projectDetailSection.map((input) => (
                            <div
                              className={`formInput ${getClassNameFromLabel(
                                input.label
                              )}`}
                              key={input.id}
                            >
                  ...
                  const imageSection = initialSections.find(
                    (init) => init === `image${section.index - 1}`
                  );
                  if (imageSection) {
                    ...
                    return (
                      <div className="uploaded-image-section-wrap">
                        <div
                          className="body image-section-title"
                        ...
                        >
                          ...
                          <div className={`image-section-${section.index}`}>
                            {[...Array(24)].map((_, index) => (
                              <div
                                ...
                                className={`image-section ${
                                  index === dragOverSection ? "drag-over" : ""
                                } list-map-wrap`}
                                onDragEnter={() =>
                                  handleDragEnter(section.index)
                                }
                                onDragLeave={handleDragLeave}
                                onDragOver={handleDragOver}
                                onDrop={(e) =>
                                  handleDrop(e, section.index, index)
                                }
                              >
                                <div>
                                <input
                                  ...
                                  />
                                  <label
                                    htmlFor={`file-${section.index}-${index}`}
                                    className="file-label primary-button"
                                  >
                                ...
                                <img
                                  src={
                                    imageFiles[section.index] &&
                                    imageFiles[section.index][index]
                                      ? URL.createObjectURL(
                                          imageFiles[section.index][index]
                                        )
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                handleRemoveField(`image${section.index}`)
                              }
                            >
                  ...
                  const textSection = textSections.find(
                    (text) => text.id === `text${section.index}`
                  );
                  if (textSection) {
                    ...
                    return (
                      <div key={`text-${section.index}`}>
                        <div className="section-wrap">
                          ...
                          <button
                            type="button"
                            onClick={() => handleRemoveField(textSection.id)}
                          >
                  ...
                  const largeImageSection = largeImageSections.find(
                    (largeImage) =>
                      largeImage.id === `largeImage${section.index}`
                  );
                      ...
                      <div key={`largeImage-${section.index}`}>
                        <div className="section-wrap">
                          ...
                          <button
                            type="button"
                            onClick={() =>
                              handleRemoveField(largeImageSection.id)
                            }
                          >
                  ...
                  const titleSection = titleSections.find(
                    (title) => title.id === `title${section.index}`
                  );
                  if (titleSection) {
                    ...
                    return (
                      <div key={`title-${section.index}`}>
                        ...
                        <button
                          type="button"
                          onClick={() => handleRemoveField(titleSection.id)}
                        >
              ...
              <div className="add-button-grid">
                ...
                <button
                  ...
                  disabled={
                    sections.includes("image") || imageSectionCount === 10
                  }
                >
                  <Masonry />
                  Add Image Section
                ...
                <button
                  ...
                  disabled={
                    sections.includes("text") || imageSectionCount === 10
                  }
                >
                  <Text />
                  Add Text Section
                ...
                <button
                  ...
                  disabled={
                    sections.includes("largeImage") || imageSectionCount === 10
                  }
                >
                  <LargeImage />
                ...
                <button
                  ...
                  disabled={
                    sections.includes("title") || imageSectionCount === 10
                  }
                >
                  <Title />
                  Add Title Section
                ...
                <React.Fragment key={index}>
                  {index === 0 ? (
                    <div className="drag-item non-drag">
                      ...
                      <div className="body">
                        {item.name || item} {item.index || null}
                      </div>
                    </div>
                  ) : (
